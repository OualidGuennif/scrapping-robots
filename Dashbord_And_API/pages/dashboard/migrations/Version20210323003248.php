 ...
 */
final class Version20210323003248 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE task (id INT AUTO_INCREMENT NOT NULL, robot_id INT NOT NULL, state VARCHAR(255) NOT NULL, `loop` INT NOT NULL, date DATETIME NOT NULL, INDEX IDX_527EDB25D5AA10AC (robot_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
